...
title('ESD sinal de música amostrado f_s=65536')
...
xlim([-1500,1500]) % Limita o gráfico à parte que interessa
title('ESD sinal de música amostrado f_s=16384')

f_s8 = 8192;
x8k = sample(original,f_s8);
EnergySpectralDensity(x8k, f_s8);
xlim([-1500,1500]) % Limita o gráfico à parte que interessa
title('ESD sinal de música amostrado f_s=8192')
...
xlim([-1500,1500]) % Limita o gráfico à parte que interessa
title('ESD sinal de música amostrado f_s=4096')

f_s2 = 2048;
x2k = sample(original,f_s2);
EnergySpectralDensity(x2k, f_s2);
xlim([-1500,1500]) % Limita o gráfico à parte que interessa
title('ESD sinal de música amostrado f_s=2048')
